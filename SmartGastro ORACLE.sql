...
insert into bestellung VALUES(2,TO_DATE('26.10.2019 20:30','dd.mm.yyyy hh24.mi'),1,0);
insert into bestellung VALUES(3,TO_DATE('27.10.2019 18:42','dd.mm.yyyy hh24.mi'),4,0);
insert into bestellung VALUES(4,TO_DATE('27.10.2019 15:10','dd.mm.yyyy hh24.mi'),8,0);
...
insert into besteht_aus VALUES(1,3,4);

insert into besteht_aus VALUES(2,1,25);
insert into besteht_aus VALUES(2,1,27);
insert into besteht_aus VALUES(2,1,4);
insert into besteht_aus VALUES(2,2,35);
insert into besteht_aus VALUES(2,2,10);

insert into besteht_aus VALUES(3,1,24);
insert into besteht_aus VALUES(3,1,16);

insert into besteht_aus VALUES(4,1,3);
insert into besteht_aus VALUES(4,1,23);
insert into besteht_aus VALUES(4,1,28);
insert into besteht_aus VALUES(4,2,11);
insert into besteht_aus VALUES(4,2,18);
insert into besteht_aus VALUES(4,2,37);
insert into besteht_aus VALUES(4,3,3);
insert into besteht_aus VALUES(4,3,23);
insert into besteht_aus VALUES(4,4,17);
insert into besteht_aus VALUES(4,4,31);
...
select idBestellung,idTisch,to_char(zeitstempel,'dd.mm.yyyy hh24.mi'),idPosten,bezeichnung,preis,typ from besteht_aus
inner join bestellung on besteht_aus.idBestellung = bestellung.id
inner join produkt on besteht_aus.idProdukt = produkt.id
