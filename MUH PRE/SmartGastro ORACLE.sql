...
CONSTRAINT ckBezahlt check(bezahlt like 'false' or bezahlt like 'true')
);
...
CONSTRAINT ckGebracht check(gebracht like 'false' or gebracht like 'true')
);
...
insert into bestellung VALUES(2,TO_DATE('26.10.2019 18:40','dd.mm.yyyy hh24.mi'),1,2,0,'false');
insert into bestellung VALUES(3,TO_DATE('26.10.2019 18:41','dd.mm.yyyy hh24.mi'),1,3,0,'false');
insert into bestellung VALUES(4,TO_DATE('26.10.2019 18:40','dd.mm.yyyy hh24.mi'),1,4,0,'false');

insert into bestellung VALUES(5,TO_DATE('26.10.2019 18:42','dd.mm.yyyy hh24.mi'),3,5,0,'false'); /*tisch 1 tablet 1*/
insert into bestellung VALUES(6,TO_DATE('26.10.2019 18:40','dd.mm.yyyy hh24.mi'),3,6,0,'false');
insert into bestellung VALUES(7,TO_DATE('26.10.2019 18:41','dd.mm.yyyy hh24.mi'),3,7,0,'false');
insert into bestellung VALUES(8,TO_DATE('26.10.2019 18:40','dd.mm.yyyy hh24.mi'),3,8,0,'false');

insert into besteht_aus VALUES(1,1,1,'false');
insert into besteht_aus VALUES(1,2,18,'false');
insert into besteht_aus VALUES(1,3,26,'false');
insert into besteht_aus VALUES(1,4,26,'false');

insert into besteht_aus VALUES(2,1,2,'false');
insert into besteht_aus VALUES(2,2,20,'false');
insert into besteht_aus VALUES(2,3,37,'false');

insert into besteht_aus VALUES(3,1,34,'false');
insert into besteht_aus VALUES(3,2,4,'false');

insert into besteht_aus VALUES(4,1,25,'false');
insert into besteht_aus VALUES(4,2,27,'false');
insert into besteht_aus VALUES(4,3,4,'false');

insert into besteht_aus VALUES(5,1,35,'false');
insert into besteht_aus VALUES(5,2,10,'false');

insert into besteht_aus VALUES(6,1,24,'false');
insert into besteht_aus VALUES(6,2,16,'false');

insert into besteht_aus VALUES(7,1,3,'false');
insert into besteht_aus VALUES(7,2,23,'false');
insert into besteht_aus VALUES(7,3,28,'false');
