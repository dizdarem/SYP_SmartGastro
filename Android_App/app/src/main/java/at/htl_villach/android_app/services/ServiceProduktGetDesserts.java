...
public class ServiceProduktGetDesserts extends AsyncTask<String, Void, String> {
    private static final String URL = "/RestaurantVerwaltung_WebService/SmartGastro/produkte/get/dessert";
    private static String ipHost = null;

    public static void setIpHost(String ipHost) {
        ServiceProduktGetDesserts.ipHost = ipHost;
    }
