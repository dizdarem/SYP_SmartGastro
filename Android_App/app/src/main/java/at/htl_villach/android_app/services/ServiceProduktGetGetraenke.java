...
public class ServiceProduktGetGetraenke extends AsyncTask<String, Void, String> {
    private static final String URL = "/RestaurantVerwaltung_WebService/SmartGastro/produkte/get/getraenk";
    private static String ipHost = null;

    public static void setIpHost(String ipHost) {
        ServiceProduktGetGetraenke.ipHost = ipHost;
    }
