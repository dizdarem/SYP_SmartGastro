...
public class ServiceProduktGetSpeisen extends AsyncTask<String, Void, String> {
    private static final String URL = "/RestaurantVerwaltung_WebService/SmartGastro/produkte/get/gericht";
    private static String ipHost = null;

    public static void setIpHost(String ipHost) {
        ServiceProduktGetSpeisen.ipHost = ipHost;
    }
